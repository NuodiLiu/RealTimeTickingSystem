...
class DeviceCleanupService {
    ...
    static async cleanupExpiredSessions() {
        try {
            ...
            const expiredSessions = await prisma_1.prisma.feedbackSession.findMany({
                where: {
                    expireAt: { lt: now },
                    status: { in: ["CREATED", "DELIVERED"] }
                }
...
exports.DeviceCleanupService = DeviceCleanupService;
//# sourceMappingURL=device-cleanup.service.js.map