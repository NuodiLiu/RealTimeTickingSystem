    ...
    try {
      switch (target) {
        ...
        case 'device':
          ...
          const deviceSent = await SignalRGateway.sendToDevice(targetDeviceId, deviceMessage);
          if (!deviceSent) {
        ...
        case 'dashboard':
          ...
          await SignalRGateway.notifyDashboard(dashboardMessage);
        ...
        case 'all':
          ...
          await SignalRGateway.broadcastToDevices(broadcastMessage);
